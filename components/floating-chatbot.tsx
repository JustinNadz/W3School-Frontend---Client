    ...
    return (
      <div className="fixed bottom-8 right-8 z-50" ref={chatbotRef}>
        ...
        <Button
          ...
          className="h-20 w-20 rounded-full bg-gradient-to-br from-[#9929EA] to-[#CC66DA] hover:from-[#CC66DA] hover:to-[#9929EA] text-white shadow-2xl relative transition-all duration-300 hover:scale-110 border-4 border-white"
          size="lg"
        >
          <MessageCircle className="h-8 w-8" />
          {userProgress.questionsAsked.length > 0 && (
            <div className="absolute -top-2 -right-2 bg-red-500 text-white text-sm rounded-full h-6 w-6 flex items-center justify-center font-bold shadow-lg">
